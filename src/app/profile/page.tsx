...
function UploadWarningBox({ className = "" }: { className?: string }) {
	return (
		<div
			className={`pointer-events-none z-50 hidden max-w-md rounded-2xl border border-white/10 bg-black/85 px-4 py-3 opacity-0 shadow-2xl shadow-black/40 backdrop-blur-md transition duration-200 md:block ${className} mx-12`}
		>
			...
			<p className="text-xs leading-5 text-muted">
				Only upload images you own or have permission to use. Do not
				upload movie posters, screenshots, celebrity photos, logos or
...
function MobileUploadWarning() {
	return (
		<div className="md:hidden">
			<div className="max-w-[260px] rounded-2xl border border-white/10 bg-white/[0.04] px-3 py-2">
				<div className="mb-1 flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wide text-accent">
		...
		<main className="min-h-screen bg-black text-white">
			<section>
				<div className="group/banner relative">
					...
					{editMode && (
						<UploadWarningBox className="absolute bottom-6 left-6 group-hover/banner:opacity-100" />
					)}
							...
							<div className="relative h-[145px] w-[145px] md:h-auto md:w-auto">
								<div className="absolute left-0 top-0 origin-top-left scale-[0.82] md:static md:scale-100">
									<div className="group/avatar relative">
										...
										{editMode && (
											<UploadWarningBox className="absolute left-1/2 top-full mt-4 w-[320px] -translate-x-1/2 group-hover/avatar:opacity-100" />
										)}
