...
// 	function handleAddToDiary(item: Movie | TvShow) {
...
// 				<div className="flex items-center justify-between px-4 mb-6 mt-12">
...
// // 						<div className="flex justify-center mt-8">
// // 							<button
// // 								onClick={() => setSearchSize(searchSize + 1)}
// // 								className="px-4 py-2 rounded bg-white/10 hover:bg-white/20"
// // 							>
// // 								Load more
// // 							</button>
