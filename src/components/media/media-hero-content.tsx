					...
					<div className="-mt-24 flex flex-col gap-4 md:mt-0 md:gap-6">
						...
						<div className="max-w-sm space-y-4">
							...
							<button
								...
								className="flex w-full items-center justify-center gap-2 rounded-full border border-accent/40 bg-accent/10 px-4 py-2 text-sm font-bold text-accent transition hover:bg-accent hover:text-white"
							>
